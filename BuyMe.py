...
class RegistrationForm(BasePage):
    ...
    def __init__(self, driver):
        BasePage.__init__(self, driver)
        self.driver = driver
        self.reg_first_name = "Ahmad"
        self.reg_email = "ahmad.aboud576@yahoo.com"
        self.password = "132248795"
...
class SenderReceiverInfo(BasePage):
    ...
    def __init__(self, driver):
        ...
        self.receiver_name = "fares"
        self.greeting_text = "its little gift for amazing person wedding birthday"
        self.image_path = "C:\\Users\\user\\Downloads\\congratulations-.jpg"
        self.email_address = "fares.aboud213@gmail.com"
        self.sender_name = "Ahmad"
